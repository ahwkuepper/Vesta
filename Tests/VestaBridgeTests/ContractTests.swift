...
struct ContractTests {
    ...
    func scenes() throws {
        let scenes = try BridgeCoding.scenes(from: fixture("scenes"), appTag: "vesta")
    ...
    @Test("Zone scenes are skipped, since Vesta shows rooms")
    ...
    @Test("Events about things Vesta does not model produce no state change")
