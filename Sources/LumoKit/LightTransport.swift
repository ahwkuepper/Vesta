...
public enum TransportAvailability: Sendable, Equatable {
    ...
    case poweredOff
    case unsupported
    /// The bridge rejected our credentials — typically Lumo was removed from the
    ...
    public var message: String? {
        switch self {
        case .ready:              nil
        case .unauthorized:       "Lumo needs Bluetooth access to find your lights."
        case .poweredOff:         "Bluetooth is turned off."
        case .unsupported:        "This Mac cannot use Bluetooth Low Energy."
        case .credentialsRejected:
            "The Bridge no longer recognises Lumo. Pair it again to reconnect."
        }
    }
}
...
public enum TransportError: LocalizedError, Equatable {
    ...
    public var errorDescription: String? {
        ...
        case .needsPairing:      "This light needs to be paired before Lumo can control it."
        case .writeFailed(let m): m
        case .unsupported:       "This isn’t available on the current connection."
        case .unauthorized:      "The Bridge no longer recognises Lumo. Pair it again."
        }
    }
}
